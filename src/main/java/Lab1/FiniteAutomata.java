...
public class FiniteAutomata {
    ...
    public static void printMatrix(List<TransitionRule> parsedFile) {
        ...
        for (TransitionRule rule : parsedFile) {
    ...
    public static List<TransitionRule> parseFile(String inputPath) throws IOException {
